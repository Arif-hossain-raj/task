...
export default function Footer() {
  return (
    <section className="footer max-w-screen-xl mx-auto px-10 pt-[80px] pb-[25px]  bg-[#F8F9FE] ">
      <div className="grid grid-cols-4 pb-[54px]">
        <div className="left">
      ...
      <div className="small flex justify-between items-center">
